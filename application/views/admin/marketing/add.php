        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo site_url('admin/marketing/add') ?>" class="form-horizontal" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="_kodemarketing_" class="col-sm-3 col-form-label" style="text-align: right;">Kode Marketing</label>
                    <div class="col-sm-6">
                      <input type="text" name="_kodemarketing_" class="form-control" id="_kodemarketing_" placeholder="Kode Marketing" value="<?php echo set_value('_kodemarketing_'); ?>" required="required" minlength="2" maxlength="50">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="_namamarketing_" class="form-control" id="_namamarketing_" placeholder="Nama Marketing" value="<?php echo set_value('_namamarketing_'); ?>" required="required" minlength="2" maxlength="50">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="_targetmarketing_" class="form-control" id="_targetmarketing_" placeholder="Target Marketing" value="<?php echo set_value('_targetmarketing_'); ?>" required="required" minlength="2" maxlength="50">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="number" name="_biayamarketing_" class="form-control" id="_biayamarketing_" placeholder="Biaya Marketing" value="<?php echo set_value('_biayamarketing_'); ?>" required="required" minlength="2" maxlength="50">
                    </div>
                  </div>
